...
本协议的双方为 Websoft9 公司和签署此协议的合作伙伴（简称“您”），同时合作伙伴销售的对象我们称之为云资源平台客户（简称为“云客户”），云客户可能会通过它的云市场将产品以免费或收费的形式供其云平台上的客户使用（简称“最终用户”）。以下内容将用到简称或这些名称。
...
根据本协议，针对每个最终用户，我们授予您一次，非排他，不可转让的权利，将订单中指定的产品转售给订单中指定的最终用户，该最终用户根据与Atlassian客户协议。此转售权不适用于任何其他最终用户或产品（包括但不限于对任何关联方，组织或关联公司的任何销售，或对同一方的任何后续，附加或续展的销售）。
